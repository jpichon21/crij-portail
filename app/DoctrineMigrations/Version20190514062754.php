 ...
 */
final class Version20190514062754 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post_route (post_id INT NOT NULL, route_id INT NOT NULL, INDEX IDX_95DFAC964B89032C (post_id), INDEX IDX_95DFAC9634ECB4E6 (route_id), PRIMARY KEY(post_id, route_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE query_query_filter (query_id INT NOT NULL, query_filter_id INT NOT NULL, INDEX IDX_27BFA0E025F9BEEE (query_filter_id), INDEX IDX_27BFA0E0EF946F99 (query_id), PRIMARY KEY(query_id, query_filter_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
