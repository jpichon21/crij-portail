 ...
 */
final class Version20190509114012 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE public public TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE public public TINYINT(1) NOT NULL');
    }
}
