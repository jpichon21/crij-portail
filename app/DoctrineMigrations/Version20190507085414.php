 ...
 */
final class Version20190507085414 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category_audit (id INT NOT NULL, rev INT NOT NULL, logo_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, intro VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, domain VARCHAR(255) DEFAULT NULL, footer VARCHAR(255) DEFAULT NULL, published TINYINT(1) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_9d60be1ae31861a527fd590d589be976_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE section_audit (id INT NOT NULL, rev INT NOT NULL, thumb_id INT DEFAULT NULL, category_id INT DEFAULT NULL, background_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, intro VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, created DATETIME DEFAULT NULL, updated DATETIME DEFAULT NULL, published TINYINT(1) DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_11e40efc0b13bde195252836548b1b9f_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE content_block_audit (id INT NOT NULL, rev INT NOT NULL, query_id INT DEFAULT NULL, content_id INT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, created DATETIME DEFAULT NULL, updated DATETIME DEFAULT NULL, position INT DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_941d0ce4cb1ea44c46ed5c633475f067_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE query_audit (id INT NOT NULL, rev INT NOT NULL, type VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, filters LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', created DATETIME DEFAULT NULL, updated DATETIME DEFAULT NULL, entity VARCHAR(255) DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_0784a93a047a3ab607481f70aca7d9b6_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE article_audit (id INT NOT NULL, rev INT NOT NULL, background_id INT DEFAULT NULL, section_id INT DEFAULT NULL, category_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, introduction TINYTEXT DEFAULT NULL, content TINYTEXT DEFAULT NULL, created DATETIME DEFAULT NULL, updated DATETIME DEFAULT NULL, archived DATETIME DEFAULT NULL, published DATETIME DEFAULT NULL, unpublished DATETIME DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_c17ec30d772af1f2052f191e1bcad73b_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE media_audit (id INT NOT NULL, rev INT NOT NULL, author_id INT DEFAULT NULL, path VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, mime_type VARCHAR(255) DEFAULT NULL, size NUMERIC(10, 0) DEFAULT NULL, altText VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, public TINYINT(1) DEFAULT NULL, revtype VARCHAR(4) NOT NULL, INDEX rev_05e5435a629dc17f25bb0ec61460bff6_idx (rev), PRIMARY KEY(id, rev)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
